        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <a class="navbar-brand mt-2 mt-lg-0" href="<?php echo BASE_URL; ?>">
                    <img src="<?php echo BASE_URL; ?>/img/bangladesh.png" style="height: 45px;" alt="MDB Logo" loading="lazy" />
                </a>
                <!-- Left links -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                        <a class="dropdown-toggle d-flex align-items-center hidden-arrow" href="#" id="navbarDropdownMenuAvatar" role="button" data-mdb-toggle="dropdown" aria-expanded="false">
                            <img src="http://localhost:3000/public/img/myPhoto.jpg" class="rounded-circle" height="45" alt="Black and White Portrait of a Man" loading="lazy" />
                        </a>
